...
_unit addGoggles "UK3CB_BAF_G_Tactical_Orange";

comment "Add weapons";
_unit addWeapon "UK3CB_BAF_L85A2";
_unit addPrimaryWeaponItem "UK3CB_BAF_Bayonet_L3A1";
...
for "_i" from 1 to 12 do {_unit addItemToVest "UK3CB_BAF_556_30Rnd_T";};
