...
*/
SR_Support_Assets = ["RHS_C130J_Cargo","globemaster_c17","RHS_C130J","RHS_A10","RHS_CH_47F"];

// Vehicle Supply Drop Setup [Display Name, Vehicle Class, Loadout Number]
SR_Vehicle_Drop = [["M1240","rhsusf_m1240a1_usmc_wd",2]];
