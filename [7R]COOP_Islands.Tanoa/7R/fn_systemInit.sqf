...
// Respawn Management
SR_Spawn_Height = 1.04845; // Height above ground the player should respawn (for respawning on ships). (check height in editor with: hint format ["%1", (getPosASL player) select 2])
